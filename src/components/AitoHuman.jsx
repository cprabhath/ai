...
const AitoHuman = () => {
  ...
  const prompts =
    "Please convert the following AI-generated text into a more natural, human style, Don't use advanced words. The original paragraph is as follows: ";
        ...
        <div className="col-6">
          <div>
            <div className="wrapper">
              ...
              >
                AI to Human Text Convertor
              </h2>
              <p className="mb-1 text-center ">
                Our AI powered text convertor tool will help you to write better
        ...
        <div className="col-6">
          <div>
            <div className="wrapper rounded-0">
              <h2 style={{ overflow: "hidden" }}>Human Text</h2>
