...
const GrammerChecker = () => {
  ...
  const prompts =
    "Corrects the grammar, punctuation, and prepositions in the given paragraph with a target accuracy of 99%. if grammar, punctuation, and prepositions are 99% correct, then show the original paragraphs. show only corrected text. The original paragraph is as follows: ";
